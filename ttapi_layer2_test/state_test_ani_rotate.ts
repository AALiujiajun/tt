...
export class State_Test_Ani_Rotate<T> implements tt2.QFrame_IState<T>
{
    ...
    async StartAsync(): Promise<void> {
        ...
        this.userplayer.userotate = true;
        this.userplayer.rotate = 0;//注意一定要给个初始值,否则是NAN，任何计算都无效
    ...
    OnUpdate(delta: number): void {
        ...
        if (touchdir != null) {
            ...
            this.userplayer.rotate = tt2.QAni_Dir2ToRotate(touchdir.X, touchdir.Y);
        ...
        this.players[1].rotate += Math.PI * 0.5 * delta;
        if (this.players[1].rotate > Math.PI * 2) {
            this.players[1].rotate = 0;
        }
        //批量更新动画
        //排序
