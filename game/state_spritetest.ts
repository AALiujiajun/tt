...
export class State_SpriteTest implements tt2.QFrame_IState<UserData>
{
    ...
    async StartAsync(): Promise<void> {
        ...
        this.cats = await tt2.QFrame_ResMgr.LoadStandaloneSpriteAsync("data/p1.jpg");


        this.atlas = await tt2.QFrame_ResMgr.LoadAtlasAsync("data/splittex_pack0.png");
